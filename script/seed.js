...
"elegantly"],
  ...
  `Whatever that shadow is, it seems to be coming straight towards you.`,
  ...
  `The shadow suddenly stops dead in it's tracks.`,
  ...
  `Damn. You really shouldn't have done that. The shadow is back and is now 3 times it's original size.`,
  `While it was leaving. The shadow tripped over a rock. What a dumb shadow.`,
  `The shadow stops leaving and mimics what you just did.`,
  `The shadow stops and is coming back with two sets of gloves. It appears it wants to shadow box.`,
  ...
  `The confused shadow now says 'Oh, now I get it.`,
  `The confused shadow is angered by what it can't possibly hope to understand. It charges at you!`,
  `The confused shadow finds you to be unpleasant. It approaches you with an unapproving look that reminds you of your father.`,
  ...
  `The shadow eats you.`,
  `The shadow was really a cat. It's sooooo cute!`,
  ...
  `The shadow was really an orange cat. The orange cat eats you.`,
  ...
  `The shadow is behind you!!!!!!!!! Too late. It tied your shoelaces together and ran away.`,
  ...
  `The shadow copied you and is deeply embarrased. The shadow eats you to get rid of all witnesses.`,
  `The shadow asks you to come over and you two continually kick the rock for the rest of the night.`,
  `The shadow starts to cry.`,
  ...
  `The shadows stop laughing and eat you.`,
  ...
  `The sound was a dog whistle. Turns out you are really a lost dog and the shadows are your family searching for you. You reunite and go home.`,
  `The sound was your alarm clock. You wake up in your bunk at ADX Florence a super maximum security prison in Fremont County Colorado.`,
  ...
  `What you just did made perfect sense to the shadow. It now understands everything and thanks you for helping enlighten it.`,
  ...
  `The shadow is really your father. He isn't mad. He's just dissapointed.`,
  ...
  `The shadow is really both of your parents. All their hopes for your future have suddenly disappeared.`,
...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({email: 'brb@email.com', password: '123'}),
