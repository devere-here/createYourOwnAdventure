...
export class SecretAdventurePage extends Component{
  ...
  render = () => {
    let indices = randomizeOptions([0, 1]),
...
const mapDispatch = (dispatch) => () => ({
  getNextSituationOptions(options){
    dispatch(getNewOptions(options, 2))
  },
...
export default connect(mapState, mapDispatch)(SecretAdventurePage)
